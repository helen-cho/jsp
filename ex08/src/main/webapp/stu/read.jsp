...
<div class="row">
	<div class="col">
		...
		<table class="table table-bordered">
			<tr>
				<td class="bg-primary text-white text-center">학생번호</td>
				<td>${stu.scode}</td>
				<td class="bg-primary text-white text-center">학생이름</td>
				<td>${stu.sname}</td>
				<td class="bg-primary text-white text-center">교수학과</td>
				<td>${stu.sdept}</td>
			</tr>
			<tr>
				<td class="bg-primary text-white text-center">생년월일</td>
				<td>${stu.birthday}</td>
				<td class="bg-primary text-white text-center">학생학년</td>
				<td>${stu.year}학년</td>
				<td class="bg-primary text-white text-center">지도교수</td>
